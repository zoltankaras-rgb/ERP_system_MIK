...
> - **Agregácie:** Ak sčituješ (km, kg, eur), vždy použi `COALESCE(SUM(stĺpec), 0)`, aby výsledok nebol NULL.
> - **Znakové sady (Collation):** Pri porovnávaní `EAN` v JOINoch (najmä pri B2B/B2C cenníkoch a produktoch) používaj `CONVERT(ean_stlpca USING utf8mb4)` na predchádzanie chybám znakovej sady (Illegal mix of collations). Príklad: `CONVERT(p1.ean_produktu USING utf8mb4) = CONVERT(p2.ean USING utf8mb4)`.

---

## Tabuľka: assistant_query_log
...
## Tabuľka: assistant_sessions
  - id: bigint, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - conversation_id: varchar(64), NULLABLE=NO, KEY=UNI
  - user_id: int, NULLABLE=YES
  - memory_json: json, NULLABLE=NO
  - last_seen: datetime, NULLABLE=NO, KEY=MUL, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: automatizovane_ulohy
  ...
  - created_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
  - updated_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: automatizovane_ulohy_log
  - id: bigint, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: b2b_ean_mapovanie  <-- POZNÁMKA PRE AI: Mapovanie interného EAN na zákaznícky objednávkový kód.
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - interny_ean: varchar(64), NULLABLE=NO, KEY=UNI
  - objednavkovy_kod: varchar(64), NULLABLE=NO
  - created_at: timestamp, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: b2b_messages
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - created_at: timestamp, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
...
## Tabuľka: b2b_objednavky
  ...
  - datum_objednavky: datetime, NULLABLE=NO, KEY=MUL, DEFAULT='CURRENT_TIMESTAMP'
...
## Tabuľka: b2b_objednavky_polozky
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: b2b_promotions
  ...
  - sold_quantity: decimal(14,3), NULLABLE=YES, DEFAULT='0.000'
  - actual_purchase_price: decimal(12,2), NULLABLE=YES, DEFAULT='0.00'

## Tabuľka: b2b_retail_chains
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: b2b_zakaznici
  ...
  - datum_registracie: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
  - phone: varchar(50), NULLABLE=YES
  - adresa: text, NULLABLE=YES
  - adresa_dorucenia: text, NULLABLE=YES
  - trasa_id: int, NULLABLE=YES, KEY=MUL  <-- POZNÁMKA PRE AI: Väzba na logistika_trasy.id
  - trasa_poradie: int, NULLABLE=YES, DEFAULT='999'
...
## Tabuľka: b2b_zakaznik_cennik
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - zakaznik_id: varchar(32), NULLABLE=NO, KEY=MUL
  - cennik_id: int, NULLABLE=NO, KEY=MUL

## Tabuľka: b2c_cennik_polozky
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - ean_produktu: varchar(32), NULLABLE=NO, KEY=MUL
...
## Tabuľka: b2c_objednavky
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - cislo_objednavky: varchar(50), NULLABLE=NO, KEY=UNI
  - zakaznik_id: varchar(32), NULLABLE=NO, KEY=MUL
  - nazov_firmy: varchar(255), NULLABLE=YES
  - datum_objednavky: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
  - pozadovany_datum_dodania: date, NULLABLE=YES, KEY=MUL
  - celkova_suma_s_dph: decimal(14,2), NULLABLE=NO, DEFAULT='0.00'
  - stav: varchar(64), NULLABLE=NO, DEFAULT='Prijatá'
  - poznamka: text, NULLABLE=YES
  - dovod_zrusenia: text, NULLABLE=YES

## Tabuľka: b2c_uplatnene_odmeny
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - zakaznik_id: varchar(32), NULLABLE=NO, KEY=MUL
...
## Tabuľka: calendar_event_notifications
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - event_id: int, NULLABLE=NO, KEY=MUL
  - event_title: varchar(255), NULLABLE=NO
  - event_type: varchar(50), NULLABLE=NO
  - event_start: datetime, NULLABLE=NO
  - event_end: datetime, NULLABLE=NO
  - channel: enum('EMAIL','SMS'), NULLABLE=NO
  - contact_id: int, NULLABLE=YES, KEY=MUL
  - target_email: varchar(255), NULLABLE=YES
  - target_phone: varchar(50), NULLABLE=YES
  - minutes_before: int, NULLABLE=NO, DEFAULT='0'
  - planned_at: datetime, NULLABLE=NO, KEY=MUL
  - status: enum('PENDING','SENT','FAILED','CANCELLED'), NULLABLE=NO, DEFAULT='PENDING'
  - sent_at: datetime, NULLABLE=YES
  - error_message: text, NULLABLE=YES
  - created_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: calendar_events
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - title: varchar(255), NULLABLE=NO
  - type: varchar(50), NULLABLE=NO, DEFAULT='MEETING'
  - start_at: datetime, NULLABLE=NO
  - end_at: datetime, NULLABLE=NO
  - all_day: tinyint, NULLABLE=NO, DEFAULT='0'
  - priority: enum('LOW','NORMAL','HIGH','CRITICAL'), NULLABLE=NO, DEFAULT='NORMAL'
  - location: varchar(255), NULLABLE=YES
  - description: text, NULLABLE=YES
  - status: enum('OPEN','DONE','CANCELLED'), NULLABLE=NO, DEFAULT='OPEN'
  - is_deleted: tinyint, NULLABLE=NO, DEFAULT='0'
  - created_by: varchar(100), NULLABLE=YES
  - created_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
  - updated_at: datetime, NULLABLE=YES, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: cena_vezg
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - datum_zaznamu: date, NULLABLE=NO, KEY=MUL
  - cena_aktualna: decimal(10,3), NULLABLE=NO
  - cena_minula: decimal(10,3), NULLABLE=NO

## Tabuľka: cennik  <-- POZNÁMKA PRE AI: B2C / špecifické SQLAlchemy cenníky (hlavička).
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - nazov: varchar(255), NULLABLE=NO
  - email: varchar(255), NULLABLE=YES
  - platnost_od: date, NULLABLE=YES
  - datum_vytvorenia: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: costs_categories
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - category_name: varchar(255), NULLABLE=NO, KEY=UNI

## Tabuľka: costs_energy_electricity
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: expedicia_inventura_polozky
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: fleet_costs
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - vehicle_id: int, NULLABLE=NO, KEY=MUL
...
## Tabuľka: fleet_logs
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - vehicle_id: int, NULLABLE=NO, KEY=MUL  <-- POZNÁMKA PRE AI: VŽDY joinuj `fleet_vehicles.id`.
...
## Tabuľka: hygiene_log
  ...
  - performed_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
...
## Tabuľka: inventurne_rozdiely_produkty
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - datum: date, NULLABLE=NO
  - ean_produktu: varchar(32), NULLABLE=NO, KEY=MUL
  - nazov_vyrobku: varchar(255), NULLABLE=NO
...
## Tabuľka: logistika_trasy
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - nazov: varchar(255), NULLABLE=NO, KEY=UNI
  - is_active: tinyint, NULLABLE=NO, DEFAULT='1'
  - created_at: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: mail_accounts
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  ...
  - created_at: datetime, NULLABLE=YES, DEFAULT='CURRENT_TIMESTAMP'
  - updated_at: datetime, NULLABLE=YES, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: mail_attachments
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: polozka_cennika
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - cennik_id: int, NULLABLE=NO, KEY=MUL
  - ean: varchar(64), NULLABLE=YES, KEY=MUL
  - nazov_produktu: varchar(255), NULLABLE=NO
  - mj: varchar(16), NULLABLE=YES, DEFAULT='kg'
  - cena: decimal(12,2), NULLABLE=NO
  - povodna_cena: decimal(12,2), NULLABLE=YES, DEFAULT='0.00'
  - dph: decimal(5,2), NULLABLE=YES, DEFAULT='20.00'
  - is_action: tinyint, NULLABLE=NO, DEFAULT='0'
...
## Tabuľka: profit_calculation_items
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
...
## Tabuľka: profit_production_monthly
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - report_year: int, NULLABLE=NO, KEY=MUL
  - report_month: int, NULLABLE=NO
  - product_ean: varchar(32), NULLABLE=NO, KEY=MUL
...
## Tabuľka: saved_contacts  <-- POZNÁMKA PRE AI: Rýchly adresár kontaktov na odosielanie cenníkov.
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - name: varchar(255), NULLABLE=NO
...
## Tabuľka: skody
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - datum: datetime, NULLABLE=NO, DEFAULT='CURRENT_TIMESTAMP'
...
## Tabuľka: system_settings
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - kluc: varchar(191), NULLABLE=YES, KEY=UNI
  - hodnota: text, NULLABLE=YES
  - updated_at: timestamp, NULLABLE=YES, DEFAULT='CURRENT_TIMESTAMP'

## Tabuľka: temps_devices
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - code: varchar(50), NULLABLE=NO, KEY=UNI
  - name: varchar(100), NULLABLE=NO
...
## Tabuľka: vw_stock_products_central — VIEW
...
## Tabuľka: vw_stock_raw_materials — VIEW
  - nazov: varchar(255), NULLABLE=NO
...
## Tabuľka: vyrobne_objednavky_polozky
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - objednavka_id: int, NULLABLE=NO, KEY=MUL
...
## Tabuľka: zaznamy_vyroba_suroviny
  - id: int, NULLABLE=NO, KEY=PRI, EXTRA=auto_increment
  - id_davky: varchar(64), NULLABLE=NO, KEY=MUL
  - nazov_suroviny: varchar(255), NULLABLE=NO, KEY=MUL
...
- **B2B Zákazníci a Trasy:** `FROM b2b_zakaznici JOIN logistika_trasy ON b2b_zakaznici.trasa_id = logistika_trasy.id`
- **B2B Cenníky a Zákazníci:** `FROM b2b_zakaznici JOIN b2b_zakaznik_cennik ON b2b_zakaznici.zakaznik_id = b2b_zakaznik_cennik.zakaznik_id JOIN b2b_cenniky ON b2b_zakaznik_cennik.cennik_id = b2b_cenniky.id`
