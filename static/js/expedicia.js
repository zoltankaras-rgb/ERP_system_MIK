...
window.switchInventoryTab = switchInventoryTab;       // <--- NOVÉ
window.saveActiveCategory = saveActiveCategory;       // <--- NOVÉ
...
window.renderStockOverviewTab = renderStockOverviewTab; // Toto ostáva pre Prehľad Skladu
